...
import com.example2.gamememory.databinding.FragmentGameFragment4x4Binding
import com.example2.gamememory.databinding.FragmentGameFragment6x6Binding



class GameFragment6x6 : Fragment() {

    private val args: GameFragmentArgs by navArgs()
    private var textG = mutableListOf<String>()
    lateinit var binding: FragmentGameFragment6x6Binding
    val anim = AnimationSlots(IndexFargment.FRAGMENT6X6)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FragmentGameFragment6x6Binding.inflate(layoutInflater)
