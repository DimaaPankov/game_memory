...
import android.widget.TextView
 ...
 enum class IndexFargment{
    FRAGMENT,FRAGMENT4X4,FRAGMENT6X6,FRAGMENT8X8
}

class AnimationSlots(val indexFargment: IndexFargment) {
    ...
    fun openToCloseCard(view1: TextView, view2: TextView, fieldSize: Int) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed({
                        ...
                        if (fieldSize2 == fieldSize) {
                            when(indexFargment) {
                             ...
                             IndexFargment.FRAGMENT8X8 ->   (_context as MainActivity).navController.navigate(R.id.action_gameFragment8x8_to_finishFragment)
                            }
                            fieldSize2 = 0
                            indexGo = 2
                        }
