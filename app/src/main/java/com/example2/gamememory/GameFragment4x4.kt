...
class GameFragment4x4 : Fragment() {
    val anim = AnimationSlots(IndexFargment.FRAGMENT4X4)

     lateinit var binding: FragmentGameFragment4x4Binding
    private val args: GameFragmentArgs by navArgs()
    private var textG = mutableListOf<String>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FragmentGameFragment4x4Binding.inflate(layoutInflater)
